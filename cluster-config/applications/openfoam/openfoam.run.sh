...
# E.g.: with 576 processes using compute nodes c5n.18xlarge with multithreading disabled, the value should be 1152 / (72/2) = 16
# E.g.: with 288 processes using compute nodes c5n.18xlarge with multithreading disabled, the value should be 1152 / (72/2) = 8
NODES=${2}
